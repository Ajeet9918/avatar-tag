...
**Controls:** Arrow keys or WASD to move. Press `R` to restart after a round ends.

## How to Play

- When you join, you're assigned a colored dot. The very first player to connect starts as **"it"** — shown with a yellow ring around their dot.
...
- When a round ends, press **R** to reset survival clocks and start a new round without needing to refresh the page.
...
- Deployment to a public host (Render/Railway) for a live shareable demo